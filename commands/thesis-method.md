...
Converter RQs e claims em um método defensável. Use antes de iniciar coleta, implementação de avaliação ou escrita do capítulo de método.

## Roteamento

Escolha um ou mais protocolos:
