...
- `contribution-contract.md`, `benchmark-card.md`, `dataset-card.md` e `claims-ledger.md`.
- Configurações versionadas para cada tratamento.
- Scripts para execução, análise, tabela e figura.

## Conclusão responsável

Restrinja a conclusão ao conjunto avaliado, à versão do agente, às métricas e ao orçamento estudado. Não extrapole para “melhora revisão de código” em geral sem evidência externa adicional.
